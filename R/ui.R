  ...
  dashboardPage(
    ...
    dashboardSidebar(
      ...
      actionButton(
        ...
        a("PROVIDE FEEDBACK",
          style = "color: #000000; border-color: #2e6da4",
          href = "mailto:jeremym@alleninstitute.org?body=''&subject='CHARGE' app comments")
      ),
    ...
    dashboardBody(
      ...
      tags$head(
        tags$style(HTML("
          ...
          /* Make the navbar a positioning context for the centered title */
          .main-header .navbar {
            position: static;
            overflow: visible;
          }
      ...
      fluidRow(
        ...
        box(
          ...
          fluidRow(
            column(11, uiOutput("dataset_description"))
          ),
          ...
          fluidRow(
            ...
            column(4, uiOutput("checkInput"))
          ),
          
          fluidRow(
            column(3, fileInput("database_upload", "UPLOAD")),
            column(6, uiOutput("database_textbox")),
            actionButton("save_view", "Save Current View")
          )
        ),
        
        box(
          title = "Select cell types for analysis and analysis type",
          solidHeader = TRUE, status = "primary", width = 12,
